        ...
        <div className="about-page">
            <div className="about-body">
                <p className="about">
                    ...
                    Now pop your popcorn, grab your snacks and get ready for the show!</p>
                <p className="aboutLogo">Enjoy The Show!</p><img className="logo-about"  src={logo} alt=''/>
                <p className="about-secondary">"This product uses the TMDb API but is not endorsed or certified by TMDb."<img className="tmdb"  src={tmdbLogo} alt=''/></p>
            </div>
        </div>
    );
}
